...
def discover(
    ...
    languages: Optional[str] = typer.Option(
        None,
        "-l", "--languages",
        help="Comma-separated languages to analyze (python,go,node,rust,kotlin,java,csharp,ruby,swift). Auto-detect if not specified.",
    ),
    ...
    if lang_set:
        valid_langs = {"python", "go", "node", "rust", "kotlin", "java", "csharp", "ruby", "swift"}
